...
public class AppointmentRepositoryTests: RepositoryTestBase
{
    ...
    public async Task GetAll_WhenAppointmentsExist_ShouldReturnAppointments()
    {
        ...
        found.Should().Contain(a => a.Username == "cust1" && a.CustomerId == customer1.CustomerId);
        found.Should().Contain(a => a.Username == "cust2" && a.CustomerId == customer2.CustomerId);
    }
    ...
    public async Task GetApptsByDate_WhenAppointmentsForDateExist_ShouldReturnThoseAppointments()
    {
        ...
        var appt1 = new AppointmentModel { Username = c1.Username, CustomerId = c1.CustomerId, ServiceId = s1.ServiceId, BarberId = b1.BarberId, appointmentDate = date };
        var appt2 = new AppointmentModel { Username = c2.Username, CustomerId = c2.CustomerId, ServiceId = s2.ServiceId, BarberId = b2.BarberId, appointmentDate = date };
        var apptOtherDay = new AppointmentModel { Username = c3.Username, CustomerId = c3.CustomerId, ServiceId = s3.ServiceId, BarberId = b3.BarberId, appointmentDate = date.AddDays(1) };
    ...
    public async Task GetByCustomerId_WhenAppointmentsForCustomerExist_ShouldReturnThoseAppointments()
    {
        ...
        var appt1 = new AppointmentModel { Username = c1.Username, CustomerId = c1.CustomerId, ServiceId = s1.ServiceId, BarberId = b1.BarberId, appointmentDate = DateTime.UtcNow.Date };
        var appt2 = new AppointmentModel { Username = c1.Username, CustomerId = c1.CustomerId, ServiceId = s2.ServiceId, BarberId = b2.BarberId, appointmentDate = DateTime.UtcNow.Date };
        var apptOther = new AppointmentModel { Username = c2.Username, CustomerId = c2.CustomerId, ServiceId = s3.ServiceId, BarberId = b3.BarberId, appointmentDate = DateTime.UtcNow.Date };
    ...
    public async Task AddAppointment_WhenDuplicateExists_ShouldReturnExistingAppointment()
    {
        ...
        var existing = new AppointmentModel { Username = c.Username, CustomerId = c.CustomerId, ServiceId = s.ServiceId, BarberId = b.BarberId, appointmentDate = DateTime.UtcNow.Date };
        _context.appointmentTable.Add(existing);
        await _context.SaveChangesAsync();

        var toAdd = new AppointmentModel { AppointmentId = existing.AppointmentId, Username = c.Username, CustomerId = c.CustomerId, ServiceId = s.ServiceId, BarberId = b.BarberId, appointmentDate = DateTime.UtcNow.Date };
    ...
    public async Task AddAppointment_WhenNew_ShouldAddAndBeRetrievableAfterSave()
    {
        ...
        var toAdd = new AppointmentModel { Username = c.Username, CustomerId = c.CustomerId, ServiceId = s.ServiceId, BarberId = b.BarberId, appointmentDate = DateTime.UtcNow.Date };
        ...
        found.Should().NotBeNull();
        found!.Username.Should().Be("cust5");
    }
    ...
    public async Task UpdateAppointment_WhenAppointmentExists_ShouldReturnUpdatedAppointment()
    {
        ...
        var existing = new AppointmentModel { Username = c.Username, CustomerId = c.CustomerId, ServiceId = s1.ServiceId, BarberId = b1.BarberId, appointmentDate = DateTime.UtcNow.Date };
        _context.appointmentTable.Add(existing);
        await _context.SaveChangesAsync();

        var updated = new AppointmentModel { AppointmentId = existing.AppointmentId, Username = "cust3_updated", CustomerId = c.CustomerId, ServiceId = s2.ServiceId, BarberId = b2.BarberId, appointmentDate = DateTime.UtcNow.Date.AddDays(1) };
        ...
        result.Should().NotBeNull();
        result!.AppointmentId.Should().Be(existing.AppointmentId);
        result.Username.Should().Be("cust3_updated");
    ...
    public async Task UpdateAppointment_WhenAppointmentDoesNotExist_ShouldReturnNull()
    {
        ...
        var updated = new AppointmentModel { AppointmentId = 999, Username = c.Username, CustomerId = c.CustomerId, ServiceId = s.ServiceId, BarberId = b.BarberId, appointmentDate = DateTime.UtcNow.Date };
